...
public class LuongNhanVienForm extends JPanel {
	...
	private JLabel lblTongSoNhanVienGiaTri;
	private JLabel lblTongSoTienLuongGiaTri;
	private JLabel lblNhanVienXuatSacGiaTri;
	...
	private ChartPanel pnlLuongNhanVien;
	private JPanel pnlMain;
	private JPanel pnl1;
	private JPanel pnlTienLuongThapNhat;
	private JPanel pnlTongSoNhanVien;
	private JPanel pnlNhanVienXuatSac;
	...
	private void thucHienChucNangThongKe() {
		...
		this.thongTinThongKe = this.luongNhanVienService.thongKeLuongNhanVienBangThangVaNam(thang, nam);
		int tongSoNhanVien = Integer.valueOf(this.thongTinThongKe.get("TongSoNhanVien").toString());
