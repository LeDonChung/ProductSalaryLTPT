...
public interface NhanVienDAO {
	 ...
	 * @return đối tượng nhân viên đã được cập nhật, hoặc null nếu cập nhật không thành công
	 */
	 ...
	 * @return true nếu cập nhật thành công trạng thái nhân viên, false nếu cập nhật không thành công
	 */
	boolean capNhatTrangThaiNghiLamCuaNhanVien(String maNhanVien);
	
	/**
	 * Hàm tìm kiếm nhân viên, có thể tìm bằng nhiều tiêu chí: mã nhân viên, họ tên, phòng ban, điện thoại, địa chỉ, CCCD, email, trình độ
	 ...
	 * @return nhân viên đã đucojw thêm thành công, hoặc null nếu thêm không thành công
	 */
	...
	/**
	 * Hàm lấy mã nhân viên cuối cùng của năm vào làm
	 * @param nam là năm đc truyền vào để truy vấn
	 * @return chuỗi ký tự là mã nhân viên cuối cùng của năm
	 */
	String layMaNhanVienCuoiCungCuaNam(int nam);
