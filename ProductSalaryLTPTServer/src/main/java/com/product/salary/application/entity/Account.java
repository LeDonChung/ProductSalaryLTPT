...
@Entity
@NamedQueries({
        @NamedQuery(name = "Account.timKiemTaiKhoanHoatDongBangTaiKhoanVaMatKhau",
                query = "SELECT a FROM Account a WHERE a.taiKhoan = :taiKhoan AND a.matKhau = :matKhau AND a.trangThai = true"),
        @NamedQuery(name = "Account.timKiemTatCaTaiKhoan",
